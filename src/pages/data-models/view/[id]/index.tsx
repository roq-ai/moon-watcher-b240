...
import { getDataModelById } from 'apiSdk/data-models';
import { DataModelInterface } from 'interfaces/data-model';

function DataModelViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('data_model', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/data-models/edit/${id}`} passHref legacyBehavior>
                    <Button
