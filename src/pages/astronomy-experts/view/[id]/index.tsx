...
import { getAstronomyExpertById } from 'apiSdk/astronomy-experts';
import { AstronomyExpertInterface } from 'interfaces/astronomy-expert';

function AstronomyExpertViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Astronomy Expert Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Astronomy Expert Details
                  </Text>
                </Box>
                {hasAccess('astronomy_expert', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/astronomy-experts/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Date Joined"
                  text={data?.date_joined ? format(parseISO(data?.date_joined as unknown as string), 'dd-MM-yyyy') : ''}
                />
