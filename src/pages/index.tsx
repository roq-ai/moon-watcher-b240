...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Moon watcher`}</title>

        <meta
          name="description"
          content="Experience the Universe with Moon Watcher: Your Reliable Companion for Real-Time Updates and Information on Moon Movements and Transits."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1682685796444-acc2f5c1b7b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxtb29ufGVufDB8fHx8MTY5MzQ5NTkzMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Universe with Moon Watcher: Your Reliable Companion for Real-Time Updates and Information on Moon Movements and Transits.`}
            </Text>
            <Box
