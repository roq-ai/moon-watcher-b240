...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'moon_movement.update': {
    roles: ['administrator', 'astronomy-expert', 'data-analyst'],
    key: 'moon-movement-update',
    tenantPath: ['organization', 'moon_movement'],
    userPath: [],
  },
  'data_model.create': {
    roles: ['administrator'],
    key: 'data-model-created',
    tenantPath: ['organization', 'data_model'],
    userPath: [],
  },
  'data_model.delete': {
    roles: ['administrator'],
    key: 'data-model-deleted',
    tenantPath: ['organization', 'data_model'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'astronomy-expert', 'data-analyst'];
