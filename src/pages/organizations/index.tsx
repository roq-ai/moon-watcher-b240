...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'astronomy_expert.count', 'data_analyst.count', 'data_model.count', 'moon_movement.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('astronomy_expert', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'astronomy_expert',
          header: 'Astronomy Expert',
          accessorKey: 'astronomy_expert',
          cell: ({ row: { original: record } }: any) => record?._count?.astronomy_expert,
        }
      : null,
    hasAccess('data_analyst', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('data_model', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'data_model',
          header: 'Data Model',
          accessorKey: 'data_model',
          cell: ({ row: { original: record } }: any) => record?._count?.data_model,
        }
      : null,
    hasAccess('moon_movement', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'moon_movement',
          header: 'Moon Movement',
          accessorKey: 'moon_movement',
          cell: ({ row: { original: record } }: any) => record?._count?.moon_movement,
        }
      : null,
